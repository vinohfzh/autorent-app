...
<head>
    ...
    <title>404 – Halaman Tidak Ditemukan | AutoRent</title>
    ...
    <style>
        ...
        .error-code { font-size: 8rem; font-weight: 800; color: #e5e7eb; line-height: 1; letter-spacing: -0.05em; }
        ...
        .btn-outline-custom { color:#4f46e5; border-color:#4f46e5; border-radius:50px; padding:0.6rem 1.5rem; font-weight:500; transition:all 0.2s; }
        .btn-outline-custom:hover { background-color:#4f46e5; color:#fff; }
    </style>
</head>
<body>
    ...
    <div class="min-vh-100 d-flex align-items-center justify-content-center text-center px-4" style="padding-top: 4rem; padding-bottom: 4rem;">
        <div>
            ...
            <i class="bi bi-signpost-split text-muted mb-3 d-block" style="font-size: 3rem;"></i>
            <h1 class="fw-bold fs-2 text-dark mb-2">Halaman Tidak Ditemukan</h1>
            <p class="text-muted mb-5" style="max-width: 400px; margin: 0 auto;">
                Sepertinya halaman yang Anda cari sudah dipindahkan, dihapus, atau tidak pernah ada. Mungkin Anda salah jalan?
            </p>
            <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
                <a href="{{ url('/') }}" class="btn btn-primary-custom text-white">
                    <i class="bi bi-house me-2"></i>Kembali ke Beranda
                </a>
                <a href="{{ url('/katalog') }}" class="btn btn-outline-custom">
